...
week_one <- read.csv("tracking_week_1.csv")
...
week1_removal <- week1_removal[-c(1, 2, 5, 8, 10, 12, 14, 15, 16, 
                                  20, 23, 24, 26, 28, 30, 31, 33, 
                                  34, 38, 40, 42), ]
...
write.csv(week1_final, file = "week1.csv", row.names = TRUE)