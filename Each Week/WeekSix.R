week_one <- read.csv("tracking_week_6.csv")
...
week1_removal <- week1_removal[-c(1, 4, 6, 8, 10, 12, 
                                  14, 16, 18, 20, 23, 24,
                                  26, 28, 30, 31, 34, 35), ]
...
week1_final <- week1_final[-c(11, 15, 16, 27), ]
...
write.csv(week1_final, file = "week6.csv", row.names = TRUE)
