week_one <- read.csv("tracking_week_9.csv")
...
week1_removal <- week1_removal[-c(2, 3, 6, 8, 10, 12, 
                                  13, 15, 17, 20, 23, 24, 
                                  26, 29, 30), ]
...
write.csv(week1_final, file = "week9.csv", row.names = TRUE)